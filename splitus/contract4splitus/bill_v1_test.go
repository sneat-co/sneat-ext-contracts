...
func TestResolvedSourceEffectValidation(t *testing.T) {
	effect := ResolvedSourceEffectV1{PriceID: "monthly", PriceRevision: 2, ExpectedAmount: exact("120.00"), AssetIDs: []string{"house"}, ContactLinks: []SourceContactLinkV1{{ContactID: "alice", Roles: []string{"participant"}}}}
