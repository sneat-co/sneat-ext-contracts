...
// export abstract class IListService extends ICommuneItemService<IListDto, LocaliusAppSchema, typeof ListKind> {
// 	abstract deleteList(listId: string, communeId: string): Observable<IListDto>;
// }
//
// export abstract class IListItemService extends ICommuneItemService<IListItemDto, LocaliusAppSchema, typeof ListItemKind> {
// 	// noinspection JSUnusedGlobalSymbols
// 	// abstract txRemoveKinds(): string[];
//
// 	// noinspection JSUnusedGlobalSymbols
// 	abstract selectByListId(tx: IRxReadonlyTransaction<LocaliusAppSchema>, listId: string, status?: ListStatus)
...
// export abstract class ILocaliusService extends RxStoreService<LocaliusAppSchema> {
