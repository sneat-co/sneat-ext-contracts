...
// IRemindiusService is the runtime-light contract the template pages and components
...
// REMINDIUS_SERVICE token below. The shared BaseListPage additionally needs the
...
export interface IRemindiusService {
...
export const REMINDIUS_SERVICE = new InjectionToken<IRemindiusService>(
  'RemindiusService',
);
