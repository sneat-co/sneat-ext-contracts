...
// export abstract class IListService extends ICommuneItemService<IListDto, RemindiusAppSchema, typeof ListKind> {
// 	abstract deleteList(listId: string, communeId: string): Observable<IListDto>;
// }
//
// export abstract class IListItemService extends ICommuneItemService<IListItemDto, RemindiusAppSchema, typeof ListItemKind> {
// 	// noinspection JSUnusedGlobalSymbols
// 	// abstract txRemoveKinds(): string[];
//
// 	// noinspection JSUnusedGlobalSymbols
// 	abstract selectByListId(tx: IRxReadonlyTransaction<RemindiusAppSchema>, listId: string, status?: ListStatus)
...
// export abstract class IRemindiusService extends RxStoreService<RemindiusAppSchema> {
