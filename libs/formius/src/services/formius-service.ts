...
// IFormiusService is the runtime-light contract the template pages and components
...
// FORMIUS_SERVICE token below. The shared BaseListPage additionally needs the
...
export interface IFormiusService {
...
export const FORMIUS_SERVICE = new InjectionToken<IFormiusService>(
  'FormiusService',
);
