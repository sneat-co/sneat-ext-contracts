...
// export abstract class IListService extends ICommuneItemService<IListDto, FormiusAppSchema, typeof ListKind> {
// 	abstract deleteList(listId: string, communeId: string): Observable<IListDto>;
// }
//
// export abstract class IListItemService extends ICommuneItemService<IListItemDto, FormiusAppSchema, typeof ListItemKind> {
// 	// noinspection JSUnusedGlobalSymbols
// 	// abstract txRemoveKinds(): string[];
//
// 	// noinspection JSUnusedGlobalSymbols
// 	abstract selectByListId(tx: IRxReadonlyTransaction<FormiusAppSchema>, listId: string, status?: ListStatus)
...
// export abstract class IFormiusService extends RxStoreService<FormiusAppSchema> {
