...
// export abstract class IListService extends ICommuneItemService<IListDto, CircleusAppSchema, typeof ListKind> {
// 	abstract deleteList(listId: string, communeId: string): Observable<IListDto>;
// }
//
// export abstract class IListItemService extends ICommuneItemService<IListItemDto, CircleusAppSchema, typeof ListItemKind> {
// 	// noinspection JSUnusedGlobalSymbols
// 	// abstract txRemoveKinds(): string[];
//
// 	// noinspection JSUnusedGlobalSymbols
// 	abstract selectByListId(tx: IRxReadonlyTransaction<CircleusAppSchema>, listId: string, status?: ListStatus)
...
// export abstract class ICircleusService extends RxStoreService<CircleusAppSchema> {
