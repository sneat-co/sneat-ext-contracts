...
// export abstract class IListService extends ICommuneItemService<IListDto, WorkAppSchema, typeof ListKind> {
// 	abstract deleteList(listId: string, communeId: string): Observable<IListDto>;
// }
//
// export abstract class IListItemService extends ICommuneItemService<IListItemDto, WorkAppSchema, typeof ListItemKind> {
// 	// noinspection JSUnusedGlobalSymbols
// 	// abstract txRemoveKinds(): string[];
//
// 	// noinspection JSUnusedGlobalSymbols
// 	abstract selectByListId(tx: IRxReadonlyTransaction<WorkAppSchema>, listId: string, status?: ListStatus)
...
// export abstract class IWorkService extends RxStoreService<WorkAppSchema> {
