...
// ITogetheredService is the runtime-light contract the template pages and components
...
// TOGETHERED_SERVICE token below. The shared BaseListPage additionally needs the
...
export interface ITogetheredService {
...
export const TOGETHERED_SERVICE = new InjectionToken<ITogetheredService>(
  'TogetheredService',
);
