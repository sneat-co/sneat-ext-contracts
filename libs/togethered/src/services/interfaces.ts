...
// export abstract class IListService extends ICommuneItemService<IListDto, TogetheredAppSchema, typeof ListKind> {
// 	abstract deleteList(listId: string, communeId: string): Observable<IListDto>;
// }
//
// export abstract class IListItemService extends ICommuneItemService<IListItemDto, TogetheredAppSchema, typeof ListItemKind> {
// 	// noinspection JSUnusedGlobalSymbols
// 	// abstract txRemoveKinds(): string[];
//
// 	// noinspection JSUnusedGlobalSymbols
// 	abstract selectByListId(tx: IRxReadonlyTransaction<TogetheredAppSchema>, listId: string, status?: ListStatus)
...
// export abstract class ITogetheredService extends RxStoreService<TogetheredAppSchema> {
