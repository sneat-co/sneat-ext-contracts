...
// export abstract class IListService extends ICommuneItemService<IListDto, RequoterAppSchema, typeof ListKind> {
// 	abstract deleteList(listId: string, communeId: string): Observable<IListDto>;
// }
//
// export abstract class IListItemService extends ICommuneItemService<IListItemDto, RequoterAppSchema, typeof ListItemKind> {
// 	// noinspection JSUnusedGlobalSymbols
// 	// abstract txRemoveKinds(): string[];
//
// 	// noinspection JSUnusedGlobalSymbols
// 	abstract selectByListId(tx: IRxReadonlyTransaction<RequoterAppSchema>, listId: string, status?: ListStatus)
...
// export abstract class IRequoterService extends RxStoreService<RequoterAppSchema> {
