...
// IRequoterService is the runtime-light contract the template pages and components
...
// REQUOTER_SERVICE token below. The shared BaseListPage additionally needs the
...
export interface IRequoterService {
...
export const REQUOTER_SERVICE = new InjectionToken<IRequoterService>(
  'RequoterService',
);
